...
public interface AndroidTextInputInterface {
	...
	/**
	 * Tell the Android app we detected the keyboard closing through non-catchable
	 * methods (such as back-button pressed)
	 */
	...
	/**
	 * Force a (reverse) change of text in the EditText (for example when using
	 * Cut/Paste/Delete)
	 */
